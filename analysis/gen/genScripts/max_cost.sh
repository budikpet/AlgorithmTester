...
../kg2 -N 250 -n 15 -m 0.8 -W 250 -w bal -C 100 -c uni -k 1.0 \
>$path/$name/"$name"_100_inst.dat

../kg2 -N 250 -n 15 -m 0.8 -W 250 -w bal -C 200 -c uni -k 1.0 \
>$path/$name/"$name"_200_inst.dat

../kg2 -N 250 -n 15 -m 0.8 -W 250 -w bal -C 300 -c uni -k 1.0 \
>$path/$name/"$name"_300_inst.dat

../kg2 -N 250 -n 15 -m 0.8 -W 250 -w bal -C 400 -c uni -k 1.0 \
>$path/$name/"$name"_400_inst.dat

../kg2 -N 250 -n 15 -m 0.8 -W 250 -w bal -C 500 -c uni -k 1.0 \
