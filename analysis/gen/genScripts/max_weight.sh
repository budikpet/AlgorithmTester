...
../kg2 -N 100 -n 10 -m 0.8 -W 300 -w bal -C 250 -c uni -k 1.0 \
>$path/$name/"$name"_300_inst.dat

../kg2 -N 100 -n 10 -m 0.8 -W 400 -w bal -C 250 -c uni -k 1.0 \
>$path/$name/"$name"_400_inst.dat

../kg2 -N 100 -n 10 -m 0.8 -W 500 -w bal -C 250 -c uni -k 1.0 \
