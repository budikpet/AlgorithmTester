...
../kg2 -N 100 -n 15 -m 0.1 -W 250 -w bal -C 250 -c uni -k 1.0 \
>$path/$name/"$name"_0,1_inst.dat

../kg2 -N 100 -n 15 -m 0.2 -W 250 -w bal -C 250 -c uni -k 1.0 \
>$path/$name/"$name"_0,2_inst.dat

../kg2 -N 100 -n 15 -m 0.3 -W 250 -w bal -C 250 -c uni -k 1.0 \
>$path/$name/"$name"_0,3_inst.dat

../kg2 -N 100 -n 15 -m 0.4 -W 250 -w bal -C 250 -c uni -k 1.0 \
>$path/$name/"$name"_0,4_inst.dat

../kg2 -N 100 -n 15 -m 0.5 -W 250 -w bal -C 250 -c uni -k 1.0 \
>$path/$name/"$name"_0,5_inst.dat

../kg2 -N 100 -n 15 -m 0.6 -W 250 -w bal -C 250 -c uni -k 1.0 \
>$path/$name/"$name"_0,6_inst.dat

../kg2 -N 100 -n 15 -m 0.7 -W 250 -w bal -C 250 -c uni -k 1.0 \
>$path/$name/"$name"_0,7_inst.dat

../kg2 -N 100 -n 15 -m 0.8 -W 250 -w bal -C 250 -c uni -k 1.0 \
>$path/$name/"$name"_0,8_inst.dat

../kg2 -N 100 -n 15 -m 0.9 -W 250 -w bal -C 250 -c uni -k 1.0 \
>$path/$name/"$name"_0,9_inst.dat

../kg2 -N 100 -n 15 -m 1.0 -W 250 -w bal -C 250 -c uni -k 1.0 \
