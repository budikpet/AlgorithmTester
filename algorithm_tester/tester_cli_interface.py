...
@click.option("-f", "--force-change", is_flag=True, help="If set then all previous output is removed before starting. If not set then the programme will start from the place it ended.")
